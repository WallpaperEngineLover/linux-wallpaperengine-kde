...
int init_encoder (const char* output_file, int sourceWidth, int sourceHeight) {
	...
	SOURCE_WIDTH, SOURCE_HEIGHT, AV_PIX_FMT_RGB24, WIDTH, HEIGHT, AV_PIX_FMT_YUV420P, SWS_BICUBIC, nullptr, nullptr,
	nullptr
    );
...
int write_video_frame (const uint8_t* rgb_data) {
    ...
    packet.dts = packet.pts; // DTS set equal to PTS for simplicity
